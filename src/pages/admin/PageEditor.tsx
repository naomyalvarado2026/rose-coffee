...
const CONNECTIVITY_MAP: Record<string, { connected: boolean; hint: string }> = {
  ...
  home_events: { connected: true, hint: 'Módulo de eventos y degustaciones de café renderizado dinámicamente en el Inicio.' },
  home_sermons: { connected: true, hint: 'Artículos del blog / novedades del café renderizados dinámicamente en el Inicio.' },
  home_birthdays: { connected: true, hint: 'Clientes destacados / testimonios renderizados dinámicamente en el Inicio.' },
  home_donations: { connected: true, hint: 'Planes de suscripción / membresía de café renderizados dinámicamente en el Inicio.' },
